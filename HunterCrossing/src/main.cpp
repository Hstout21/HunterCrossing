...
#include <vector>
#include <memory>
#include "GLViewHunterCrossing.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewHunterCrossing > glView( Aftr::GLViewHunterCrossing::New( args ) );
